...
import {
    faGithub, faInstagram, faLinkedin, faTwitter, faYoutube,
    ...
    return (<main className="container">
        <section className="profile">
            ...
            <div className="profile-text">
                <h1>HILMI SAFAK</h1>
                {/*
                    <button className="flex my-0 sm:my-4" onClick={() => setTheme(resolvedTheme === "dark" ? "light" : "dark")}>
